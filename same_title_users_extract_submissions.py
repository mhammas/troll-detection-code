...
user_list = {}
suspected_title_dict = {}
for i in range(0, 8):
    f = open('/data/hammas/same_title_users_again/shortlisted_user_submissions_' + str(i) + '.json', 'r')
...
def my_func(proc_number): 
    f1 = open('/data/hammas/same_title_users_data/shortlisted_user_submissions_' + str(proc_number) + '.json', 'w')
